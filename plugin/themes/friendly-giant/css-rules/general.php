<?php
	...
	return array(
		...
		'overlap_background_color' => array(
			...
			'selector' => '.onp-sl-overlap-box.onp-sl-dark-force-theme .onp-sl-overlap-background'
		),
		...
		'outer_border_bottom_color' => array(
			'css' => 'border-bottom-color: {value|onp_to_rgba};',
			'selector' => '.onp-sl-dark-force'
		),
		'outer_border_size' => array(
			'css' => 'border-width: {value} !important;',
			'selector' => '.onp-sl-dark-force'
		),
		...
		'header_text' => array(
			array(
				...
				'selector' => '.onp-sl-dark-force .onp-sl-strong'
			),
			array(
				'css' => 'background-image: url("{image}") !important;',
				'selector' => '.onp-sl-dark-force .onp-sl-text .onp-sl-strong:before, .onp-sl-dark-force .onp-sl-text .onp-sl-strong:after'
			)
		),
		'message_text' => array(
			'css' => array(
			...
			'selector' => '.onp-sl-dark-force .onp-sl-text .onp-sl-message, .onp-sl-dark-force .onp-sl-text p'
		),
		// end text
		...
		'container_paddings' => array(
			...
			'selector' => '.onp-sl-dark-force .onp-sl-screen'
		),
		'after_header_margin' => array(
			'css' => 'margin-bottom: {value}px !important;',
			'selector' => '.onp-sl-dark-force .onp-sl-text .onp-sl-strong'
		),
		'after_message_margin' => array(
			'css' => 'margin-bottom: {value}px !important;',
			'selector' => '.onp-sl-dark-force .onp-sl-text'
		),
		'after_controls_margin' => array(
			'css' => 'margin-bottom: {value}px !important;',
			'selector' => '.onp-sl-dark-force .onp-sl-group-inner-wrap'
		),
		// end paddings
	);