<?php
	...
	return array(
		...
		'signin_button_cover_twitter_color' => array(
			...
			'selector' => '.onp-sl-download .onp-sl-connect-buttons .onp-sl-twitter'
		),
		// - facebook
		'signin_button_cover_facebook_color' => array(

			'css' => 'background: {value} !important;',
			'selector' => '.onp-sl-download .onp-sl-connect-buttons .onp-sl-facebook'
		...
		'signin_button_cover_google_color' => array(
			...
			'css' => 'background: {value} !important;',
			'selector' => '.onp-sl-download .onp-sl-connect-buttons .onp-sl-google'
		...
		'signin_button_cover_linkedin_color' => array(
			...
			'css' => 'background: {value} !important;',
			'selector' => '.onp-sl-download .onp-sl-connect-buttons .onp-sl-linkedin'
		...
		'signin_button_cover_text_font' => array(
			...
			'selector' => '.onp-sl-download .onp-sl-connect-buttons .onp-sl-control'
		),
		// end button text
