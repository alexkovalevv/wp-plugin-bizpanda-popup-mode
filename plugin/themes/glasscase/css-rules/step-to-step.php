<?php
	...
	return array(
		...
		'sts_active_tab_mark_bg_color' => array(
			...
			'selector' => '.onp-sl-glasscase .onp-sts-progress-line .onp-sts-top-line span'
		),
		...
		'sts_active_tab_line_bg_color' => array(
			'css' => 'background-color: {value|onp_to_rgba} !important;',
			'selector' => '.onp-sl-glasscase .onp-sts-progress-line .onp-sts-top-line'
		),
		...
		'sts_default_tab_mark_bg_color' => array(
			'css' => 'background-color: {value|onp_to_rgba} !important;',
			'selector' => '.onp-sl-glasscase .onp-sts-progress-line span'
		),
		...
		'sts_default_tab_line_bg_color' => array(
			'css' => 'background-color: {value|onp_to_rgba} !important;',
			'selector' => '.onp-sl-glasscase .onp-sts-progress-line .onp-sts-step-mark'
		),
		'sts_default_tab_line_text_color' => array(
			'css' => 'color: {value|onp_to_rgba} !important;',
			'selector' => '.onp-sl-glasscase .onp-sts-progress-line'
		)
		// end active screen
	);